...
import 'package:admin_app/bloc/auth/auth_state.dart';
...
void main() {
  ...
  runApp(
    MultiProvider(
      ...
      child: BlocProvider(
        create: (_) => AuthBloc(
            // AuthBloc manages the authentication state of the app
            authService:
                authService), // Initializes the AuthBloc with an instance of authService
        child: MyApp(),
      ),
    ),
  );
