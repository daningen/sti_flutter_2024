  ...
  import 'vehicle/vehicles_view.dart';
            ...
            if (isWideScreen)
              NavigationRail(
                ...
                onDestinationSelected: (index) {
                  ...
                  final routes = [
                    '/start', // Matches '/start' root
                    '/start/statistics', // Matches '/start/statistics'
                    '/start/parkings', // Matches '/start/parkings'
                    '/start/parking-spaces', // Matches '/start/parking-spaces'
                    '/start/vehicles', // Matches '/start/vehicles'
                    '/start/persons', // Matches '/start/persons'
                  ];
